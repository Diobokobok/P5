package com.example.muhamaddio;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupData() {
        ...
        Shape apricot = new Shape("9", "Apricot           48 Calories", R.drawable.rambutan);
        shapeList.add(apricot);

        Shape manggo = new Shape("10", "Manggo            60 Calories", R.drawable.pepaya);
